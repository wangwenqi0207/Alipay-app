...
//     var user = my.getStorageSync('userName');
//     this.setData({
//       user: user
//     })
//     var card = my.getStorageSync('idCard');
//     this.setData({
//       card: card
//     })
//     var sex = my.getStorageSync('sex');
//     this.setData({
//       sex: sex
//     })
//     var detail_phone = my.getStorageSync('phoneNumber');
//     this.setData({
...
//               my.getStorageSync("filepic1", filepic1)
//               that.setData({
//                 filesName: data.file
//               })
//             }
...
//               my.setStorageSync("filepic2", filepic2)
//               that.setData({
