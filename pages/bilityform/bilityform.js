...
//   }, 
  ...
  //         }else{
  //             console.log("通过")
  //      var url = url +"ins_self_assessment_update";
  //                   var insName = this.data.name;
  //                   my.setStorageSync('insName', insName);
  //                   var insIdcard =this.data.idcard;
  //                   my.setStorageSync('insIdcard', insIdcard);    
  //                   var address = this.data.address;
  //                   my.setStorageSync('address', address);      
  //                   var contactName = this.data.linkname;
  //                   my.setStorageSync('contactName', contactName); 
  //                   var contactIdcard = this.data.linkcard;
  //                   my.setStorageSync('contactIdcard', contactIdcard); 
  //                   var contactPhone = this.data.linkNum;
  //                   my.setStorageSync('contactPhone', contactPhone); 
